...
export const ChatArea: React.FC = () => {
  ...
  // Get message counts from SWR
  const { messages: roomMessages } = useRoomMessages(currentRoom?.id || null);
  const { messages: privateMessages } = usePrivateMessages(
    currentPrivateChat?.id || null
  );
